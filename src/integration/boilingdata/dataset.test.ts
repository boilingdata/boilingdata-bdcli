...
const exampleConfigValid = yaml.load(
  fs.readFileSync(path.join(__dirname, "fixtures/datasources_valid.test.yaml")).toString(),
);
const exampleConfigExtraKeys = yaml.load(
  fs.readFileSync(path.join(__dirname, "fixtures/datasources_extra.test.yaml")).toString(),
);
const exampleConfigBadValues = yaml.load(
  fs.readFileSync(path.join(__dirname, "fixtures/datasources_bad.test.yaml")).toString(),
);
